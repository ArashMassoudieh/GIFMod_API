...
int main()
{
    ...
    mCreate.AddBody("topsoil", inputpath + "topsoilbottom.csv", "theta=0.35, porosity=0.4, ks=0.1, theta_s=0.4, theta_r=0.05, vg_alpha=3.6, vg_n=1.56, lambda=0.5, storativity=0.01","");
    ...
    {
        VTK_grid moisture_topsoil = M.VTK_get_snap_shot("topsoil", &mCreate, "theta",t,1,"theta");
        //VTK_grid moisture_deepsoil = M.VTK_get_snap_shot("deepsoil", &mCreate, "theta",t,1,"theta");
		...
		//VTK_edge_grid Percolation_Flow = M.VTK_get_snap_shot_edges("percolation", &mCreate, "Q", t, 1, "Q");
